...
list("Налейте в кастрюлю воду");
list("Достаньте из холодильника пельмени");
list("Забросьте пельмени в горячую воду. ОСТОРОЖНО, НЕ ОБОЖГИТЕСЬ!", "list__item_warning");
list("Посолите и поперчите по вкусу");
list("Ждите готовности");
list("Приятного аппетита!", "list__item_warning");
